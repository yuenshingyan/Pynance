...
def regime_detection(historical_price, bollinger_bands="No", sub_view="Volitility"):
  ...
  try:
    ...
    if sub_view == "RSI":
      ...
      upper_threshold = Span(location=70, dimension='width', line_color='#FFDB46', line_width=1, line_alpha=0.4, line_dash='dashed')
      lower_threshold = Span(location=30, dimension='width', line_width=1, line_alpha=0.4, line_dash='dashed')
