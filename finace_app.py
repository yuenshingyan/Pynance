...
cols_name4[0].write(f"{(1 - choose_condidence_lvl) * 100}% confidence that our portfolio of ${capital} will not exceed losses greater than ${round(value_at_risk, 2)} over a {investing_period.days} day period.")
