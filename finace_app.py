...
#   close_low_volatility = historical_price[Z_Close == 1]
  ...
  p_historical.vbar(historical_price.index[inc], w, historical_price["Open"][inc], historical_price["Adj Close"][inc], width=20*60*60*1000, fill_color="#99FFCC", line_color="black", legend_label="Adjusted Close Price (Inc)")
  p_historical.vbar(historical_price.index[dec], w, historical_price["Open"][dec], historical_price["Adj Close"][dec], width=20*60*60*1000, fill_color="#F2583E", line_color="black", legend_label="Adjusted Close Price (Dec)")
  ...
  p_log_ret.vbar(x=historical_price.index, top=(np.exp(returns_high_volatility) - 1) * 100, width=20*60*60*1000, color="#FFDB46")
  p_log_ret.vbar(x=historical_price.index, top=(np.exp(returns_low_volatility) - 1) * 100, width=20*60*60*1000)
